<?php
namespace Pfay\Contacts\Model\Product;

/**
 * Interceptor class for @see \Pfay\Contacts\Model\Product
 */
class Interceptor extends \Pfay\Contacts\Model\Product implements \Magento\Framework\Interception\InterceptorInterface
{
